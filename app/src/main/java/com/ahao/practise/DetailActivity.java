...
/**
 * Our secondary Activity which is launched from {@link com.ahao.practise.MainActivity}. Has a simple detail UI
...
public class DetailActivity extends AppCompatActivity {
    ...
    private GridImageViewItem mItem;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mItem = GridImageViewItem.getItem(getIntent().getIntExtra(EXTRA_PARAM_ID, 0));
